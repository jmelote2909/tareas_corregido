        ...
        <div class="space-y-4">
            ...
            <div class="space-y-3 min-h-[500px]">
                @foreach($tasks->where('status', $status) as $task)
                    <a href="/tarea/{{ $task->id }}" wire:navigate class="block bg-white p-4 rounded-xl border-2 border-slate-100 shadow-sm hover:shadow-md hover:border-slate-200 transition-all group">
