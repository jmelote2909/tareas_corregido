    ...
    <div class="flex">
        ...
        <div class="flex-1 p-5 space-y-3">
            ...
            <div class="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-100">
                ...
                @endif
                <a href="/tarea/{{ $task->id }}" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold text-slate-600 hover:text-slate-800 transition-colors">
