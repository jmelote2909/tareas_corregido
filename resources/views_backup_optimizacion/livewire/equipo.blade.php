                ...
                <div class="p-10 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    @if(!$editingEmployeeId)
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" wire:model.debounce.700ms="userSearch" placeholder="Escribe un nombre o correo..." class="w-full h-14 bg-slate-50 border-2 border-slate-50 rounded-2xl px-12 outline-none focus:border-indigo-500 focus:bg-white transition-all text-slate-800 font-bold">
