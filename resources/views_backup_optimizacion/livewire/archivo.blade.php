    ...
    <div class="bg-[#fffdf0] rounded-[40px] p-8 shadow-sm border border-amber-100/50 mb-10">
        ...
        <div class="grid grid-cols-4 gap-6">
            ...
            <div class="relative group">
                ...
                <input wire:model.debounce.700ms="searchQuery" type="text" placeholder="Buscar en archivo..." 
            ...
            @if(auth()->user()->role === 'admin')
                <div class="relative">
                    <select wire:model.change="filterEmployee" class="w-full pl-4 pr-10 py-3 bg-white border border-amber-100 rounded-2xl outline-none focus:ring-4 focus:ring-amber-500/5 focus:border-amber-400 transition-all text-[#1a2344] font-medium appearance-none cursor-pointer">
            ...
            <!-- Category -->
            <div class="relative">
                <select wire:model.change="filterCategory" class="w-full pl-4 pr-10 py-3 bg-white border border-amber-100 rounded-2xl outline-none focus:ring-4 focus:ring-amber-500/5 focus:border-amber-400 transition-all text-[#1a2344] font-medium appearance-none cursor-pointer">
            ...
            <!-- Year -->
            <div class="relative">
                <select wire:model.change="filterYear" class="w-full pl-4 pr-10 py-3 bg-white border border-amber-100 rounded-2xl outline-none focus:ring-4 focus:ring-amber-500/5 focus:border-amber-400 transition-all text-[#1a2344] font-medium appearance-none cursor-pointer">
