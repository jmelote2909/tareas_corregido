@props(['active', 'href', 'label' => '', 'icon' => ''])

@php
$classes = ($active ?? false)
            ? 'flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all bg-white/20 text-white border border-white/10 shadow-lg'
            : 'flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all text-white/60 hover:text-white hover:bg-white/10 transition-all';
...
$icons = [
    ...
    'user-plus' => '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-3-3.87"/><path d="M11 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v6"/><path d="M16 11h6"/></svg>',
    ...
    'chart' => '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 16l3-4 3 2 5-6"/></svg>',
